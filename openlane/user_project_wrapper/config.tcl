...
set ::env(CLOCK_PORT) "lfsr32int.Clk lfsr32ext.Clk mprj.ClkIngress user_clock2"
...
set ::env(VERILOG_FILES_BLACKBOX) "\
	...
	$script_dir/../../verilog/rtl/lfsr32.v \
	$script_dir/../../verilog/rtl/user_proj_example.v"

set ::env(EXTRA_LEFS) "\
	$script_dir/../../lef/stc0_core.lef \
	$script_dir/../../lef/lfsr32.lef \
	$script_dir/../../lef/user_proj_example.lef"

set ::env(EXTRA_GDS_FILES) "\
	$script_dir/../../gds/stc0_core.gds \
	$script_dir/../../gds/lfsr32.gds \
